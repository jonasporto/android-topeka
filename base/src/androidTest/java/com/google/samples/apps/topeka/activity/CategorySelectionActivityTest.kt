...
class CategorySelectionActivityTest {
    ...
    val activityRule @Rule get() = object :
            ActivityTestRule<com.google.samples.apps.topeka.categories.activity.CategorySelectionActivity>(com.google.samples.apps.topeka.categories.activity.CategorySelectionActivity::class.java) {
        ...
        override fun getActivityIntent(): Intent {
            ...
            return com.google.samples.apps.topeka.categories.activity.CategorySelectionActivity.getStartIntent(targetContext, TEST_PLAYER)
        }
    }
