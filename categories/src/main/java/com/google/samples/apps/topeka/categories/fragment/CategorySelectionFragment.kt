...
class CategorySelectionFragment : Fragment() {
    ...
    private val adapter: com.google.samples.apps.topeka.categories.adapter.CategoryAdapter? by lazy(LazyThreadSafetyMode.NONE) {
        activity?.run {
            com.google.samples.apps.topeka.categories.adapter.CategoryAdapter(this,
