...
package com.google.samples.apps.topeka.quiz.activity
...
import com.google.samples.apps.topeka.quiz.widget.TextSharedElementCallback
...
class QuizActivity : AppCompatActivity() {
    ...
    private var quizFragment: com.google.samples.apps.topeka.quiz.fragment.QuizFragment? = null
    ...
    override fun onResume() {
        if (savedStateIsPlaying) {
            with(findFragmentByTag(FRAGMENT_TAG) as com.google.samples.apps.topeka.quiz.fragment.QuizFragment) {
    ...
    private fun initQuizFragment() {
        ...
        quizFragment = com.google.samples.apps.topeka.quiz.fragment.QuizFragment.newInstance(category.id, solvedStateListener)
        // the toolbar should not have more elevation than the content while playing
        setToolbarElevation(false)
    }
    ...
    private val solvedStateListener
        get() = object : com.google.samples.apps.topeka.quiz.fragment.QuizFragment.SolvedStateListener {
    ...
    private fun submitAnswer() {
        ...
        if (quizFragment == null) {
            quizFragment = findFragmentById(R.id.quiz_fragment_container) as com.google.samples.apps.topeka.quiz.fragment.QuizFragment
        }
