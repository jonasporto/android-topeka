...
package com.google.samples.apps.topeka.quiz.widget.quiz
...
import com.google.samples.apps.topeka.quiz.widget.fab.CheckableFab
...
(context: Context, private val category: Category, val quiz: Q) : FrameLayout(context) {
    ...
    private fun performScoreAnimation(answerCorrect: Boolean) {
        (context as com.google.samples.apps.topeka.quiz.activity.QuizActivity).lockIdlingResource()
    ...
    private fun proceed() {
        if (context is com.google.samples.apps.topeka.quiz.activity.QuizActivity) (context as com.google.samples.apps.topeka.quiz.activity.QuizActivity).proceed()
    }
